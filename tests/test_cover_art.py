...
from cover_art import CoverArtDownloader, CoverArtEmbedder, CoverArtManager
...
class TestCoverArtDownloader(unittest.TestCase):
    ...
    @patch('cover_art.urllib.request.urlopen')
...
class TestCoverArtEmbedder(unittest.TestCase):
    ...
    @patch('cover_art.CoverArtEmbedder.embed_mp4')
    ...
    @patch('cover_art.CoverArtEmbedder.embed_mp3')
...
class TestCoverArtManager(unittest.TestCase):
    ...
    @patch('cover_art.CoverArtDownloader.download')
    @patch('cover_art.CoverArtEmbedder.embed')
