...
echo "  python main.py temperament          # AI-based Playlist Temperament Analysis"
echo "  python main.py enrich               # Metadata Filling and Enrichment"
echo "  python main.py organize             # Playlist Organization by Genre"
echo ""
echo "Options:"
echo "  python main.py -v                   # Verbose logging"
echo "  python main.py --help               # Show help"
echo "  python main.py --version            # Show version"
echo ""
