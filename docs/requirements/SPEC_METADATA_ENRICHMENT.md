...
## Overview
Automatic metadata filling and enrichment system that retrieves missing audio metadata (BPM, Genre, Year) from multiple databases and applies it to music tracks in Apple Music.
...
- Standard library: `json`, `logging`, `argparse`
...
### T4: Database Queries
- MusicBrainz: Track search, metadata retrieval
- Spotify: Track search, metadata retrieval
- Last.fm: Track popularity, genre tags
